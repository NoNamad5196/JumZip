...
const result = { schemaVersion: 1, mode: 'ZERO_NETWORK_PREFLIGHT', promptVersion: PERSONA_PROMPT_VERSION, model, createdAt: new Date().toISOString(),
  ...
  proposedLiveBudgetNeurons: 3500, livePrerequisites: ['Main verifies00UTC/09KST free reset', 'Independent v7 micro8 review completed', 'Main explicitly approves full84 and budget'],
  acceptanceStatus: 'NOT_RUN_NO_QUALITY_INFERENCE', pricingSource: 'https://developers.cloudflare.com/workers-ai/platform/pricing/' };
const directory = 'tests/persona/benchmark-runs/v7-full84-preparation'; await mkdir(directory, { recursive: true });
